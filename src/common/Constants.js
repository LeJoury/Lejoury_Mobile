...
Constants.Itinerary_Type = {
	Type: {
		COUNTRY_ITINERARY: 'COUNTRY_ITINERARY',
...
Constants.Actions = {
	Types: {
		...
		SETUP_FOLLOWERS: 'SETUP_FOLLOWERS',
		UPDATE_FOLLOWERS: 'UPDATE_FOLLOWERS',
		SETUP_FOLLOWING: 'SETUP_FOLLOWING',
		...
		UPDATE_HOME_ITINERARIES: 'UPDATE_HOME_ITINERARIES',
